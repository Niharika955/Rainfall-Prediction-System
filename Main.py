...
main = tkinter.Tk()
main.title("Enhancing Prediction Accuracy of Rainfall Using Machine Learning and Forecasting Methods")
...
def runSVM():
    ...
    for i in range(len(actual)):
        ...
        if forecast[i] < 30:
            status = "No Rain"
        text.insert(END,"Day "+str((i+1))+" Actual Rainfall : "+str(actual[i])+" Predicted Rainfall : "+str(forecast[i])+" "+status+"\n\n")
...
font = ('times', 15, 'bold')
title = Label(main, text='Enhancing Prediction Accuracy of Rainfall Using Machine Learning and Forecasting Methods')
